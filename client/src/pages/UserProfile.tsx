            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  disabled={!isEditing}
                  className="pl-10 w-full text-black p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-600 focus:border-transparent disabled:bg-gray-100"
                  value={formData.name}
